 ...
 */
@RestController
@RequestMapping("/a2a/reservation")
public class ReservationA2AController extends BaseA2AControllerSupport {

    public ReservationA2AController(
        ...
        super(chatService, scopeResolver, activationService, lifecycleService, responseMapper, objectMapper, AgentScopeName.RESERVATION);
    }
